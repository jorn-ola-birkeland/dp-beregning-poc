...
fun Int.jun(år: Int) = DagTidspunkt.med(LocalDate.of(år, 6, this))
fun Int.jul(år: Int) = DagTidspunkt.med(LocalDate.of(år, 7, this))
fun Int.aug(år: Int) = DagTidspunkt.med(LocalDate.of(år, 8, this))
fun Int.sep(år: Int) = DagTidspunkt.med(LocalDate.of(år, 9, this))
fun Int.okt(år: Int) = DagTidspunkt.med(LocalDate.of(år, 10, this))
